...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;只要注册一个企业微信就可以，并且是免费的不用验证主体就可以使用，但需要实名认证，这里需要注意一点，权限什么的一定要设置好（企业可以搜索到，别名要打开等设置）。比较好的就是直接关注自己企业的微信公众号，就可以通过微信API推送消息了，还可以在聊天栏置顶，消息不会错过，并且可以添加多个应用来推送不同的消息。美滋滋啊，芜湖起飞。
